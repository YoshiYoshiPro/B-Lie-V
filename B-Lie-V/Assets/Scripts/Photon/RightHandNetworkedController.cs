...
public class RightHandNetworkedController : MonoBehaviourPunCallbacks, IPunObservable
{ 
    ...
    void Start()
    {
        ...
        HandTransform = GameObject.Find("Player/MRTK XR Rig/Camera Offset/MRTK RightHand Controller").transform;
